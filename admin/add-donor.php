...
$status=1;
$sql="INSERT INTO donors(FullName,MobileNumber,EmailId,Age,Gender,BloodGroup,Address,Message,status) VALUES(:fullname,:mobile,:email,:age,:gender,:blodgroup,:address,:message,:status)";
...
<head>
	...
	<title>BDB| Admin Add Donor</title>
	<!-- Font awesome -->
